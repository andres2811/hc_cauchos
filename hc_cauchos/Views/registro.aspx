                    ...
                    <div id="formContent">
                        <div class="fadeIn first">
                            ...
                            <div class="form-group">
                                ...
                                <br />
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ErrorMessage="Solo se permiten letras minimo 3" ControlToValidate="TB_nombres" ValidationExpression="[a-zA-Z ]{3,35}"  ValidationGroup="Registro" Font-Underline="True" ForeColor="Red"></asp:RegularExpressionValidator>
                                ...
                                <br />
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ErrorMessage="Solo se permiten letras minimo 5" ControlToValidate="TB_apellidos" ValidationExpression="[a-zA-Z ]{3,35}" ValidationGroup="Registro" ForeColor="Red"></asp:RegularExpressionValidator>
                                ...
                                <asp:TextBox ID="TB_contraseña" runat="server" class="form-control rounded-pill" placeholder="contraseña" MaxLength="16"  ValidationGroup="Registro"></asp:TextBox>     
                                ...
                                <br />
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Se requiere entre 8 - 16 caracteres tanto letras,numeros,mayusculas y minusculas" ControlToValidate="TB_contraseña" ValidationExpression="^(?=\w*\d)(?=\w*[A-Z])(?=\w*[a-z])\S{8,16}$" ValidationGroup="Registro" Font-Size="X-Small" ForeColor="Red"></asp:RegularExpressionValidator>

                                <asp:TextBox ID="TB_confirmar_contra" runat="server" class="form-control rounded-pill" placeholder="confirmar contraseña" MaxLength="16" ValidationGroup="Registro"></asp:TextBox>
