<%@ Page Title="" Language="C#" MasterPageFile="~/Views/administrador/admin.master" AutoEventWireup="true" CodeFile="~/Controllers/administrador/configurarAdmin.aspx.cs" Inherits="Views_administrador_configurar" %>
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                ...
                <div class="form-group">
                    ...
                    <asp:Button ID="BTN_editarCorreo" runat="server" Text="Cambiar" class="btn btn-primary" OnClick="BTN_editarCorreo_Click" ValidationGroup="grupocorreo" />
