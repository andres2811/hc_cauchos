<%@ Page Title="" Language="C#" MasterPageFile="~/Views/administrador/admin.master" AutoEventWireup="true" CodeFile="~/Controllers/administrador/Mision_Vision_Objetivo.aspx.cs" Inherits="Views_administrador_Mision_Vision_Objetivo" %>
            ...
            <div class="row">
                 ...
                 <div class="col-4">
                      <div class="form-group">
                          ...
                          <br />
                          <asp:Button ID="BTN_ActializarO" runat="server" Text="Actualizar" class="btn btn-primary" OnClick="BTN_ActializarO_Click" ValidationGroup="objetivo" />
